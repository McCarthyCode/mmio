...
See https://github.com/McCarthyCode/mmio/issues/7 for active issue on CI/CD pipeline integration via GitHub Actions.
...
**TODO** — On each PR, run unit and E2E tests.

### Deployment

**TODO** — On each `main` commit, automate the process of deploying to AWS (e.g., Lambda).
